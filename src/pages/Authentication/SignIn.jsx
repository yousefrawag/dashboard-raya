  ...
  const [loading , setLoading] = useState(false)
    const handelLogin = async (e) =>{
      ...
      try {
       ...
       if(!data.email){
        return toast.error("يجب إدخال  البريد الخاص بيك")
       }
       if(!data.password){
        return toast.error("يجب إدخال  كلمة المرور")
       }
       setLoading(true)
        const res = await authFetch.post("/login" ,data)
        ...
        <div className="w-full  xl:w-1/2 xl:border-l-2 ">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5  rounded-tl-[30px] rounded-bl-[30px]">
              ...
              <form onSubmit={handelLogin}>
                ...
                <div className="mb-5">
                  {
                    loading && <span>جارى تسجيل الدخول ...</span>
                  }
                  <input
                    type="submit"
                    value="تسجيل الدخول"
                    className="w-full cursor-pointer rounded-lg  bg-main p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
                ...
                <div className="mt-6 text-center">
                  ...
                  هل نسيت كلمة المرور الخاصة بك?{' '}
                    <Link to="/auth/ForgetPassword" className="text-main">
                      إعاده تعين كلمة المرور
                    </Link>
                  </p>
                </div>
              </form>
          ...
          <div className="hidden w-full xl:block xl:w-1/2 bg-main  rounded-tr-[30px] rounded-br-[30px]">
