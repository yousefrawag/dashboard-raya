...
const FloorNumber = () => {
    const {data , isLoading , isError} = useQuerygetiteams("FloorNumber", "FloorNumber")
    const {deleteIteam} = useQueryDelete("FloorNumber" , "FloorNumber")
...
,
  ...
  return (
    <div>
        ...
        <Breadcrumb  pageName="اعداد الطوابق "/>
        {
          isAdmin || CanAdd ?
...
<CustomeTabel  data={data?.data?.data} columns={columns}/>
 ...
 <MdouleAddCategoray  fetshkey="FloorNumber" titale="الطابق"/>
 <EditmainCategory  fetshkey="FloorNumber" titale="الطابق"/>
    </div>
  )
}
