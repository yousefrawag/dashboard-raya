...
const PaymentMonthly = () => {
    const {data , isLoading , isError} = useQuerygetiteams("monthPayment", "monthPayment")
    const {deleteIteam} = useQueryDelete("monthPayment" , "monthPayment")
...
<CustomeTabel  data={data?.data?.data} columns={columns}/>
 ...
 <MdouleAddCategoray  fetshkey="monthPayment" titale="الدفعة الشهرية"/>
 <EditmainCategory  fetshkey="monthPayment" titale="الدفعة الشهرية"/>
    </div>
  )
}
