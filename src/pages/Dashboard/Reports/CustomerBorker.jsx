   ...
   moduleType: status
     ...
     updateiteam( { id , data }, {
        onSuccess: () => {
          ...
          toast.success("تم تحديث حاله العميل");
        },
      });
} catch (error) {
      ...
      <div className="relative">
        ...
        //   disabled={updatingId === row._id}
          className={`
            ...
            ${row.moduleType === "underReview" 
              ? 'bg-yellow-50 border-yellow-300 text-yellow-700' 
              : 'bg-green-50 border-green-300 text-green-700'
            }
            focus:outline-none focus:ring-2 focus:ring-opacity-50
            ${row.moduleType === "underReview" ? 'focus:ring-yellow-400' : 'focus:ring-green-400'}
        ...
        >
          ...
          <option value="customer" className="bg-green-50 text-green-700">
             تمت المراجعة
          </option>
        </select>
