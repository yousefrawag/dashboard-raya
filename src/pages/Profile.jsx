...
const Profile = () => {
  ...
  const res = await authFetch.put(`/users/update` , formData)
console.log(res)
    if(res.status === 200){
      toast.success("تم التعديل بنجاح")
      dispatch(login(res.data.updatedUesr))
              ...
              <div className="p-7">
                <form onSubmit={onSubmit}>
                  ...
                  <div className="flex justify-end gap-4.5">
                    ...
                    <Link to="/user-changepassword"  className="flex justify-center rounded bg-main py-2 px-6 font-medium text-gray hover:bg-opacity-90"
                    >
                    تغير كلمه المرور
                    </Link>
                  </div>
              ...
              <div className="p-7">
                <form action="#">
                  <div className="mb-4 flex items-center gap-3">
                    <div className="h-14 w-14 rounded-full" style={{borderRadius:"50%"}}>
                      <img src={user?.imageURL} alt="User" style={{borderRadius:"50%"}}/>
                    </div>
                    <div>
                  ...
                  <div
                    id="FileUpload"
                    className="relative mb-5.5 block w-full cursor-pointer appearance-none rounded border border-dashed border-primary bg-gray py-4 px-4 dark:bg-gray-800 sm:py-7.5"
                  >
